...
Criado uma esteira de prompts para gerar cada etapa do processo criativo.
...
- Roteiro e capa gerado via gemini
...
- 🤖 1. Use os prompts de roteiro e arte no arquivo `gemini`
